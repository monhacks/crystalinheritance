...
.FindGrass:
	...
	ld a, [hli]
	cp GROUP_RUINS_OF_ALPH_AERODACTYL_WORD_ROOM ; changed from group_navel_rock_inside
	jr nz, .not_navel_rock_group
	ld b, a
	ld a, [hli]
	cp MAP_RUINS_OF_ALPH_AERODACTYL_WORD_ROOM 
...
.loadwildmon
	...
	ld a, [wMapGroup]
	cp GROUP_VIOLET_CITY ; changed to VIOLET_CITY from SOUL_HOUSE Soul House or Lavender Radio Tower
	jr nz, .not_ghost
	ld a, [wMapNumber]
