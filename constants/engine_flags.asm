...
; wVisitedSpawns , see data/events/engine_flags
	const ENGINE_FLYPOINT_PLAYERS_HOUSE
	const ENGINE_FLYPOINT_ANARRES_TOWN  ; PALLET 
	const ENGINE_FLYPOINT_GAULDENROD ; VIRIDIAN 
	const ENGINE_FLYPOINT_WESTERN_CAPITAL ; MT MOON 
	const ENGINE_FLYPOINT_TRADERS_LANDING ; CERULEAN 
	const ENGINE_FLYPOINT_SHELTERED_SHORES ; CERULEAN CAPE
	const ENGINE_FLYPOINT_CIANWOOD_COVE ; ROCK TUNNEL 
	const ENGINE_FLYPOINT_TRANQUIL_TARN ; VERMILLION 
	const ENGINE_FLYPOINT_EERIE_HAMLET  ; LAVENDER 
	const ENGINE_FLYPOINT_SULFUR_STY ; SAFFRON 
	const ENGINE_FLYPOINT_TIMELESS_TAPESTRY ; CELADON  
	...
	const ENGINE_FLYPOINT_UNUSED_1
	const ENGINE_FLYPOINT_UNUSED_2
	const ENGINE_FLYPOINT_UNUSED_3
	const ENGINE_FLYPOINT_UNUSED_4
	const ENGINE_FLYPOINT_UNUSED_5
	const ENGINE_FLYPOINT_UNUSED_6
	const ENGINE_FLYPOINT_UNUSED_7
	const ENGINE_FLYPOINT_UNUSED_8
	const ENGINE_FLYPOINT_UNUSED_9
