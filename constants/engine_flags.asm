...
; wVisitedSpawns ; HOW DO THESE CONNECT TO THE FLYPOINTS?
	const ENGINE_FLYPOINT_PLAYERS_HOUSE
	const ENGINE_FLYPOINT_ANARRES 
	const ENGINE_FLYPOINT_GAULDENROD; 
	const ENGINE_FLYPOINT_STADIUM
	const ENGINE_FLYPOINT_WESTERN_CAPITAL
	const ENGINE_FLYPOINT_TRADERS_LANDING
	const ENGINE_FLYPOINT_SHELTERED_SHORES
	const ENGINE_FLYPOINT_CIANWOOD_COVE
	const ENGINE_FLYPOINT_TRANQUIL_TARN
	const ENGINE_FLYPOINT_EERIE_HAMLET ; NOT USED BEYOND THIS
