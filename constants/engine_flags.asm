...
; wVisitedSpawns , see data/events/engine_flags
	...
	const ENGINE_FLYPOINT_FUCHSIA ; UNUSED
	const ENGINE_FLYPOINT_CINNABAR ; UNUSED
	const ENGINE_FLYPOINT_INDIGO_PLATEAU  ; UNUSED
	const ENGINE_FLYPOINT_NEW_BARK ; UNUSED
	const ENGINE_FLYPOINT_CHERRYGROVE ; UNUSED 
	const ENGINE_FLYPOINT_PEWTER ; PEWTER
