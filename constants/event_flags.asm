...
; Johto Gym Leader TM gifts
	...
	const EVENT_GOT_TM67_AVALANCHE ; unused 
	const EVENT_DRAGON_PULSE
; HMs
	const EVENT_GOT_HM01_CUT
	const EVENT_GOT_HM02_FLY ; unused 
...
; Johto story events
	...
	const EVENT_GOT_CYNDAQUIL
	const EVENT_GOT_OSHAWOTT
	const EVENT_GOT_ROWLET
	const EVENT_ACCEPTED_ADRINNA ;FROM MYSTERY EGG EVENT
	const EVENT_AMOS_INTRO_MINE
	const EVENT_KURT_HEARS_LOGGERS
	const EVENT_CHARCOAL_TALKED 
	const SLOWPOKE_WELL_MOVED_ASIDE ;EVENT_INTRODUCED_FELICITY
	const EVENT_GOT_CHARCOAL ; used to be lass connie
	const EVENT_GOT_ANARRES_BERRY ; preston
	const EVENT_TALKED_TO_HOLLIS ; JASMINE RETURNED
	const EVENT_BEAT_TAMMY ;new 
	const EVENT_ANCHORAGE_OVERQWIL_1 ; NEW 
	const EVENT_ANCHORAGE_OVERQWIL_2 ; NEW
	const EVENT_SUMMONED_CELEBI_IN_ILEX ;ss ticket
	const EVENT_LISTENED_TO_HEABUTT_INTRO ; new
	const EVENT_TALKED_TO_PRYCE_TINDER_GARDEN ; new 
	const EVENT_TAMMY_HOLLYS_HOLT ; NEW 
	const EVENT_SAW_KLEAVOR ; DONT NEED
	const EVENT_GOT_RETURN_PRYCE ; new 
	const EVENT_ANARRES_HOLT_GATE ; NEW
	const EVENT_CLEARED_SLOWPOKE_WELL
	const EVENT_BEAT_SANDRA ; new
	const EVENT_STADIUM_BOX_SANDRA ; new
	const EVENT_MADE_UNOWN_APPEAR_IN_RUINS
	const EVENT_BEAT_BOBESH_STADIUM
	const EVENT_GOT_LEMONADE_FROM_LADY ; new 
	const EVENT_KIMONO_CABIN_1_CARBOS
	const EVENT_GAULDENROD_UNDERGROUND_MOVED ; new 
	const EVENT_STADIUM_BOX_ADRINNA ; new 
	const EVENT_TAUGHT_COUNTER ; new 
	const EVENT_GRAMPS_SADDLE ; new 
	const EVENT_KURT_GAVE_YOU_APRICORN_BOX
	const EVENT_INITIALIZED_EVENTS
	const EVENT_UNDERGROUND_BIG_ROOT ; new
	const EVENT_STADIUM_GROUNDS_SECOND_FLOOD ; new
	const EVENT_TOXICROAK_STADIUM ; NEW 
	const EVENT_LAKE_OF_RAGE_ELIXIR_ON_STANDBY
	const EVENT_HEALED_MOOMOO ; KEEP
	const EVENT_GOT_TM62_ACROBATICS_FROM_MOOMOO_FARM
	const EVENT_STADIUM_UNDERGROUND_MOVED_ASIDE ; NEW 
	...
	const EVENT_STADIUM_GROUNDS_FIRST_FLOOD ; new
	const EVENT_BEAT_ELITE_FOUR
	const EVENT_GOT_UNOWN ; FROM SHUCKIE, KEEP
	const EVENT_MANIA_TOOK_SHUCKIE_OR_LET_YOU_KEEP_HIM ; DON'T NEED
	const EVENT_ILEX_FOREST_RIVAL ; new 
	const EVENT_GOT_PINK_BOW_FROM_MARY
	const EVENT_USED_BASEMENT_KEY ; DONT NEED
	const EVENT_4F_BRIGADER ; new 
	const EVENT_4F_AMOS ; NEW 
	const EVENT_GOT_GAULDENROD_POKEMON ;NEW
	const EVENT_GOT_TM05_ROAR
	const EVENT_NO_EVENT ; NULL , ALWAYS SET TO 0 
	const EVENT_GOT_EEVEE
	const EVENT_GOT_KENYA
	const EVENT_BARBEAU_WARPED
	const EVENT_BASCULEGION_LIVES ; new 
	...
	const EVENT_BASCULEGION_SLEEPS ; NEW 
	const EVENT_BATTLED_AMOS_GARDEN ; NEW 
	const EVENT_GOT_ITEMFINDER_FROM_PROF_OAKS_AIDE ; new
	const EVENT_GOT_BICYCLE
	const EVENT_BATTLED_BASCULEGION
	const EVENT_BATTLED_RAIKOU
	const EVENT_BEAT_ADRINNA_MINE
	const EVENT_BEAT_ADRINNA_TOWER ; NEW 
	const EVENT_MET_FRIEDA_OF_FRIDAY
	const EVENT_GOT_POISON_BARB_FROM_FRIEDA
	const EVENT_BEAT_AMOS
	const EVENT_BEAT_BARBEAU_REDOUBT
	const EVENT_MET_ARTHUR_OF_THURSDAY
	const EVENT_BEAT_BOBESH_TOWER
	const EVENT_BEAT_HOLLIS_REDOUBT
	const EVENT_BEAT_KANNA
	const EVENT_BEAT_KENSEY_PORT
	const EVENT_GOT_BLACK_BELT_FROM_WESLEY
	const EVENT_BEAT_KENSEY_TOWER
	...
	const EVENT_BEAT_PRYCE_GYM
	const EVENT_BEAT_RIVAL_THEATRE
	const EVENT_BOULDER1_IN_GLACIER
	const EVENT_GOT_TM47_STEEL_WING ; USED
	const EVENT_BOULDER2_IN_GLACIER ; NEW 
	const EVENT_TOLD_ELM_ABOUT_TOGEPI_OVER_THE_PHONE
	const EVENT_BOULDER_CRADLE1F_1
	const EVENT_BOULDER_CRADLE1F_2
	...
	const EVENT_GOT_AIR_BALLOONS_FROM_ROUTE_32_LEADER ; NEW 
	const EVENT_GOT_SLOWPOKETAIL_ROUTE32 ; new 
	const EVENT_BOULDER_CRADLE1F_3 ; NEW 
	const EVENT_GAULDENROD_BRIGADER_CINDY ; NEW 
	const EVENT_PROLOGUE_MEJIMI ; NEW 
	const EVENT_PROLOGUE_ADRINNA ; NEW 
	const EVENT_PROLOGUE_KENSEY ; NEW 
	const EVENT_SERENE_SPRINGS_ROCKY_HELMET ; new 
	const EVENT_PROLOGUE_BOBESH ; NEW 
	const EVENT_PROLOGUE_SAMSARA ; NEW 
	const EVENT_BRASS_TOWER_18F_ITEM
	...
	const EVENT_BRASS_TOWER_HYPER_POTION
	const EVENT_CAVE_DRAGON_SCALE
	const EVENT_CC_HEATRAN
; Johto hidden items
	...
	const EVENT_SHIMMER_HIDDEN_1
	const EVENT_SHIMMER_HIDDEN_2
	const EVENT_SHIMMER_HIDDEN_3
	...
	const EVENT_CIANWOODCAVE_HIDDEN_ETHER
	const EVENT_CIANWOODCAVE_HYPER_POTION
	const EVENT_WISHERS_HIDDEN_BIG_NUGGET
	const EVENT_WISHERS_HIDDEN_BERRY_1 ; 
	const EVENT_WISHERS_HIDDEN_FULL_RESTORE ; 
	const EVENT_WISHERS_HIDDEN_MAX_REVIVE ; 
	const EVENT_CIANWOODCITY_LUGIA
	const EVENT_CIANWOODCOVE_BERRY_1
	const EVENT_CIANWOODCOVE_BERRY_2
	...
	const EVENT_HOLLYS_HOLT_HIDDEN_SILVERPOWDER
	const EVENT_HOLLYS_HOLT_HIDDEN_REVIVAL_HERB
	const EVENT_HOLLYS_HOLT_ENERGYPOWDER
	const EVENT_ILEX_FOREST_REVIVAL_HERB
	const EVENT_RUINS_OF_ALPH_OUTSIDE_HIDDEN_RARE_CANDY
	const EVENT_SERENE_SPRINGS_ELIXIR ; new
	const EVENT_WISHERS_HIDDEN_BERRY_2
	const EVENT_ROUTE_34_HIDDEN_SUPER_POTION ; ; USED 
	const EVENT_KAJO_REVIVE ; used 
	const EVENT_KAJO_POTION ; used
	const EVENT_KAJO_SOUVENIR ; used 
	const EVENT_KAJO_REVIVE2 ; used 
	const EVENT_KAJO_POTION2 ; used 
	const EVENT_KAJO_ETHER ; used 
	const EVENT_KAJO_ELIXIR ; used 
	const EVENT_SLOWPOKE_WELL_B2F_SCHOOLBOY ; NEW 
	const EVENT_ROUTE_34_HIDDEN_RARE_CANDY
	const EVENT_CIANWOOD_COVE_KURT
	...
	const EVENT_CRADLE_1F_CART
	const EVENT_CRADLE_1F_CART_1
	const EVENT_BEAT_ADRINNA_MOUNT_MORTAR ; NEW 
	...
	const EVENT_BEAT_SILVER
	const EVENT_GOT_FLASH_CANNON ; new 
	const EVENT_CRADLE_1F_FULL_RESTORE
	const EVENT_CRADLE_1F_MAX_REVIVE
	const EVENT_CRADLE_1F_NUGGET
	const EVENT_CRADLE_1F_SOUVENIR
	const EVENT_CRADLE_2F_CART_1
	const EVENT_CRADLE_BOULDER_1
	const EVENT_CRADLE_BOULDER_2
	const EVENT_CRADLE_CUTSCENE
	const EVENT_CRADLE_HIDDEN_1
	const EVENT_CRADLE_HIDDEN_2
	const EVENT_CRADLE_HIDDEN_3
	const EVENT_DOCKS_BARBEAU
	const EVENT_DOCKS_KENSEY
	const EVENT_DOCKS_KURT
	const EVENT_DOCKS_LUGIA
	const EVENT_DOCKS_SURGE
	const EVENT_DREAMS_POKEBALL
	const EVENT_EUSINE_ROUTE_42
; Crystal-exclusive events in Johto
	const EVENT_EXTENT_ITEM_1
	const EVENT_EXTENT_ITEM_2
	const EVENT_EXTENT_ITEM_3
	const EVENT_FIRST_LIGHTNING_ROOF
	const EVENT_FOUGHT_ENTEI
	const EVENT_FOUGHT_LAKE_RIVAL
	const EVENT_CAN_GIVE_GS_BALL_TO_KURT
	const EVENT_GAVE_GS_BALL_TO_KURT
	const EVENT_FOREST_IS_RESTLESS
	const EVENT_GAULDENROD_ELDER
	const EVENT_GAVE_MYSTERY_EGG_TO_ELM
	const EVENT_GOT_EXP_SHARE_FROM_PROF_OAKS_AIDE
	const EVENT_GLACIER_ADRINNA
	const EVENT_GLACIER_KANNA
	const EVENT_GOT_TM46_THIEF_FROM_LANCE
	const EVENT_VALERIE_ECRUTEAK_CITY
	const EVENT_VALERIE_BELLCHIME_TRAIL
	const EVENT_GOT_ASSAULT_VEST
	const EVENT_GOT_CHOICE_BAND
	const EVENT_GOT_ELECTRIZER
	const EVENT_GOT_HSLIGGOO_EGG
	const EVENT_GOT_LEFTOVERS
	const EVENT_GOT_NET_BALL_FROM_GOLDENROD
	const EVENT_GOT_LIFE_ORB
	const EVENT_GOT_ASSAULT_VEST_FROM_CIANWOOD
	const EVENT_GOT_RAZOR_ITEM_ROUTE_40
	const EVENT_GOT_SS_TICKET_FROM_ELM
	const EVENT_GOT_SHINY_CHARM_FROM_PROF_OAKS_AIDE
; Kanto story events
	const EVENT_ILEX_SHRINE_CELEBI ;EVENT_GOT_NUGGET_FROM_GUY
	const EVENT_GOT_MINT_LEAF ;trade quest1, EVENT_INTRODUCED_TO_CERULEAN_MAN
	const EVENT_LEARNED_ABOUT_MACHINE_PART
	const_skip ; unused
	const EVENT_GOT_RETURN_FROM_PRYCE ; NEW?
	const EVENT_HOLT_MIRACLE_SEED ; NEW 
	const EVENT_GOT_MUSCLE_BAND ; new
	const EVENT_RESTORED_POWER_TO_KANTO
	const EVENT_GAULDENROD_BOBESH ; NEW 
	const EVENT_SANDRA_WARPED ; new
	const EVENT_GOT_LUCKY_EGG_FROM_GRANNY ; NEW 
	const EVENT_WHITNEY_GYM ; NEW
	const EVENT_GAVE_FACADE ; NEW 
	const EVENT_GOT_BASEMENT_KEY ; new 
	const EVENT_INTRODUCED_TEALA ; old but new
	const EVENT_GOT_COIN_CASE_FROM_BILLS_MOM ; new 
	const EVENT_GOT_BERRY_GLORIA ; NEW 
	const EVENT_GENTLEMAN_READ_TRAIN_MAIL ; NEW
	const EVENT_TRADED_BRICK_PIECE ; NEW
	const EVENT_INTRODUCED_POKEFAN_M ; NEW 
	const EVENT_GAVE_METAL_COAT_GOLDENROD ; NEW
	const EVENT_GAVE_NEVERMELTICE_GOLDENROD ; NEW
	const EVENT_GAVE_DRAGON_FANG_GOLDENROD ; NEW
	const EVENT_RIVAL_RADIO_TOWER ; NEW 
	const EVENT_FOUGHT_RADIO_TOWER_RIVAL ; NEW 
	const EVENT_BEAT_RADIO_TOWER_RIVAL ; new
	const EVENT_INTRODUCED_HEX_MANIAC ; new
	const EVENT_GAVE_SPELL_TAG_ANARRES ; new
	const EVENT_GAVE_TWISTEDSPOON_ANARRES ; new
	const EVENT_GAVE_BLACKGLASSES_ANARRES ; new 
	const EVENT_GOT_FLY_KURT ; new
	const EVENT_GOT_TM48_ROCK_SLIDE ; NEW
	const EVENT_WIDE_LENS ; NEW
	const EVENT_GOT_WATER_PULSE ; NEW
	const EVENT_NATIONAL_PARK_DESTINY_KNOT ; NEW
	const EVENT_UNION_CAVE_HARD_STONE ; NEW
	const EVENT_GOT_MYSTIC_WATER_ANARRES ; new
	const EVENT_CALM_COAST_SOFT_SAND ; NEW
	const EVENT_MAGNET_TRAIN_MAGNET ; NEW
	const EVENT_GOT_AMULET_COIN ; NEW 
	const EVENT_GOT_SILK_SCARF_FROM_MEMORIES_NPC ; new
	const EVENT_GOT_SHARP_BEAK_FROM_MEMORIES_NPC ; new
	const EVENT_GOT_POISON_BARB_FROM_MEMORIES_NPC ; new 
	const EVENT_VISITED_NAVEL_ROCK ; old but needs to be kept :) never set !
	const EVENT_VISITED_FARAWAY_ISLAND ; old but needs to be kept
	const EVENT_KURT_UNDERGROUND ; NEW 
	const EVENT_READ_WHITNEY_RADIO_SCRIPT ; new 
	const EVENT_ROUTE_KAJO_HIDDEN_HYPER_POTION ; new 
	const EVENT_ROUTE_KAJO_HIDDEN_FULL_RESTORE ; new 
	const EVENT_ROUTE_KAJO_HIDDEN_REVIVE ; new 
	const EVENT_ROUTE_KAJO_HIDDEN_NUGGET ; new 
	const EVENT_TALKED_TO_LOST_KAJO_GIRL ; new 
	const EVENT_TALKED_TO_CABIN_DAD ; new 
	const EVENT_GOT_BRIGHTPOWDER_KAJO ; new 
	const EVENT_KIMONO_CABIN_MORPHEA_NOTEBOOK; new 
	const EVENT_GAULDENROD_TUNNELERS ; new 
	const EVENT_HOLT_PINECO_1 ; 
	const EVENT_HOLT_PINECO_2 ; 
	const EVENT_HOLT_PINECO_3 ; 
	const EVENT_GAULDENROD_AMOS ; 
	const EVENT_GAULDENROD_ADRINNA ; 
...
; Orange story events
	const EVENT_KAJO_SCHOOLGIRL ; 
	const EVENT_GOT_BIG_NUGGET_FROM_ROUTE_34_LEADER ; NEW 
	const EVENT_GOT_PROTECT_PADS_FROM_LIGHTHOUSE_LEADER ; keep 
	const EVENT_STADIUM_GROUNDS_SANDRA ;NEW 
	const EVENT_GAULDENROD_CIVILIANS ; new 
	const EVENT_GAULDENROD_FLAREON ; NEW 
	const EVENT_MISTY_BASIN_B1F_BLACKBELT ; NEW 
	const EVENT_LISTENED_TO_BODY_SLAM_INTRO
; Kanto hidden items
	const EVENT_ANARRES_PPUP ; 
	const EVENT_ANARRES_ETHER ; 
	const EVENT_STADIUM_BOX_SCOPE_LENS ; NEW
	const EVENT_BEAT_SAMSARA ; new 
	const EVENT_GOT_TM_CALM_MIND
	const EVENT_GOT_TM_ENERGY_BALL
	const EVENT_GOT_TM_EXPLOSION
	const EVENT_GOT_TM_FLASH
	const EVENT_GOT_TM_FOCUS_BLAST
	const EVENT_GOT_TM_GIGA_IMPACT
	const EVENT_GOT_TM_POISON_JAB
	const EVENT_GOT_TM_SCALD
	const EVENT_GOT_TM_STONE_EDGE
	const EVENT_GOT_TM_WILD_CHARGE
	const EVENT_GOT_VOLT_SWITCH
	const EVENT_GOT_WHIRLPOOL_WHIRL_ISLANDS
	const EVENT_BEAT_DRAGON_TAMER_HANK2
	const EVENT_BEAT_DRAGON_TAMER_JONES2
	const EVENT_BEAT_DRAGON_TAMER_LELAND2
	const EVENT_BEAT_ELDER_AKIRA
	const EVENT_BEAT_ELDER_HIROSHI
	const EVENT_BEAT_ELDER_ISAMU
	const EVENT_BEAT_ELDER_KAITO
	const EVENT_BEAT_ELDER_NOBORU
	const EVENT_BEAT_ELDER_SATORU
	const EVENT_BEAT_ELDER_TADAO
	const EVENT_BEAT_ELDER_TAKASHI
	const EVENT_BEAT_ELDER_YOSHI
	const EVENT_BEAT_ENGINEER_GOETH
	const EVENT_BEAT_ENGINEER_INGSOL
	const EVENT_BEAT_ENGINEER_NOBEL
	const EVENT_BEAT_MEDIUM_ESTHER
	const EVENT_BEAT_NINJA1
	const EVENT_BEAT_NINJA10
	const EVENT_BEAT_NINJA11
	const EVENT_BEAT_NINJA12
	const EVENT_BEAT_NINJA2
	const EVENT_BEAT_NINJA3
	const EVENT_BEAT_NINJA4
	const EVENT_BEAT_NINJA5
	const EVENT_BEAT_NINJA6
	const EVENT_BEAT_NINJA7
	const EVENT_BEAT_NINJA8
	const EVENT_BEAT_NINJA9
	const EVENT_BEAT_OFFICER_DIRK
	const EVENT_BEAT_RUIN_MANIAC_ROB
	const EVENT_BEAT_SAGE_URI
	const EVENT_BEAT_SAGE_VIRGIL
	const EVENT_DUBIOUS_DISC ; USED 
	const EVENT_BEAT_SANDRA_REDOUBT
	const EVENT_BEAT_SWIMMER_M_CHARLIE
	const EVENT_BEAT_SWIMMER_M_HAROLD
	const EVENT_BEAT_SWIMMER_M_RANDALL
	const EVENT_BEAT_SWIMMER_M_SIMON
	const EVENT_GROTTOITEM
	const EVENT_HEARD_CIANWOOD_SHPEEL
	const EVENT_JASMINE_GYM
	const EVENT_KAJO_DAWN_STONE
	const EVENT_KAJO_ICE_STONE
	const EVENT_KAJO_SCHOOLGIRL_CABIN
	const EVENT_KAJO_SUDOWOODO
	const EVENT_KIMONO_CABIN_4_LAPRAS_BATTLE
	const EVENT_KIMONO_CABIN_DUSK_STONE
	const EVENT_KIMONO_CABIN_SHINY_STONE
	const EVENT_KURT_INTRO_MINE
	const EVENT_KURT_LIGHTHOUSE_1
	const EVENT_KURT_MINE_2
	const EVENT_LAKE_HURSALUNA
	const EVENT_LAKE_KURT
	const EVENT_LAKE_RIVAL
	const EVENT_LANDING_SCENE_1_BARBEAU
	const EVENT_LANDING_SCENE_1_KENSEY
	const EVENT_LANDING_SCENE_1_KURT
	const EVENT_LIGHTHOUSE_RAIKOU
	const EVENT_LIGHTNING_1
	const EVENT_LIGHTNING_2
	const EVENT_LIGHTNING_3
	const EVENT_LISTENED_TO_KURT_4
	const EVENT_LISTENED_TO_SLEEP_TALK_INTRO
	const EVENT_LUGIA_POKEBALL
	const EVENT_MILTANK_39_MOVED_ONCE
	const EVENT_MILTANK_COWGIRL
	const EVENT_MILTANK_SUICUNE
	const EVENT_NEXUSB1F_ESCAPE_ROPE
	const EVENT_NEXUSB1F_HYPER_POTION
	const EVENT_NEXUSB2F_ITEM1
	const EVENT_NEXUSB2F_ITEM2
	const EVENT_NEXUSB2F_ITEM3
	const EVENT_NEXUSB2F_ITEM4
	const EVENT_NEXUSB2F_ITEM5
	const EVENT_NEXUSB2F_ITEM6
	const EVENT_NEXUS_B1F_BOULDER_1
; Orange hidden items
	const EVENT_BEAT_ENGINEER_JOSEPH ; 
	const EVENT_NEXUS_B1F_FALLS_1_OFF ; move 
	const EVENT_NEXUS_B1F_FALLS_2_OFF ; move 
	const EVENT_NEXUS_B1F_FALLS_3_OFF ; move 
	const EVENT_NEXUS_B1F_FALLS_4_OFF ; move 
	const EVENT_NEXUS_B2F_FALLS_SWITCH ; move 
	const EVENT_NEXUS_HIDDEN_CALCIUM
	const EVENT_NEXUS_HIDDEN_PROTEIN
...
; More Johto story events
	...
	const_skip ; unused
	const EVENT_SLOWPOKE_WELL_SLOWBRO;EVENT_MET_BILLS_GRANDPA
...
; Johto Gym Leaders
	...
	const EVENT_BEAT_MORTY_GYM ; revised
...
; GruntF
	const EVENT_BEAT_KIMONO_GIRL_MASAKO ; new 
	const EVENT_BEAT_KIMONO_GIRL_HARUKO ; new 
	const EVENT_BEAT_KIMONO_GIRL_TAMIKO ; new 
...
; Biker
	...
	const EVENT_BEAT_NOMAD_M_JOEL 
	const EVENT_BEAT_NOMAD_M_GLENN
	const EVENT_BEAT_NOMAD_M_DALE
	const EVENT_BEAT_NOMAD_M_JACOB
...
; Artist
	const EVENT_BEAT_NOMAD_F_REINA
	const EVENT_BEAT_NOMAD_F_ALINA
	const EVENT_BEAT_NOMAD_F_MARLENE
	const EVENT_BEAT_NOMAD_F_RIN
; Aroma Lady
...
; Johto itemballs
	...
	const EVENT_KIMONO_TM_SUBSTITUTE ; USED 
	...
	const EVENT_NEXUS_HIDDEN_ZINC
	const EVENT_NOMAD_ISLANDS_HOUSE
	const EVENT_BURNED_TOWER_1F_HP_UP
	const EVENT_NOMAD_NEXUS
	...
	const EVENT_REDOUBT_ITEM_1
	const EVENT_REDOUBT_ITEM_2
	const EVENT_REDOUBT_ITEM_3
	const EVENT_OLIVINE_LIGHTHOUSE_6F_SUPER_POTION
	const EVENT_OLIVINE_LIGHTHOUSE_ROOF_SILVER_LEAF
	const EVENT_REDOUBT_ITEM_4
	const EVENT_REDOUBT_ITEM_5
	const EVENT_REDOUBT_KURT
	const EVENT_RIVAL_LIGHTHOUSE
	const EVENT_ROOF_HOOH
	const EVENT_ROOF_JOLTEON
	const EVENT_ROOF_LUGIA
	const EVENT_ROUTE39_MILTANK
	const EVENT_ILEX_FOREST_REVIVE
	const EVENT_WAREHOUSE_ENTRANCE_COIN_CASE
	const EVENT_ROUTE_39_SLUDGE
	const EVENT_ROUTE_40_KURT
	...
	const EVENT_GOT_TM_X_SCISSOR
	const EVENT_ROUTE_41_SAGE_1
	const EVENT_ROUTE_41_SAGE_2
	const EVENT_ROUTE_42_EUSINE_INTRO
	const EVENT_ROUTE_43_HURSALUNA
	const EVENT_ROUTE_43_ULTRA_BALL
	const EVENT_RR_OPENED_HATCH
	const EVENT_RUSALKA_B1F_X_ATTACK
	const EVENT_RUSALKA_B1F_X_SPEED
	const EVENT_RUSALKA_RAZOR_FANG
	const EVENT_RUSALKA_SPIRITOMB
	const EVENT_RUSALKA_WILLOWISP
	const EVENT_SAVED_MILTANK ; probably can move out of vis section if needed 
	const EVENT_SHIMMER_GRAMPS_1
	const EVENT_SHIMMER_GRAMPS_2
	const EVENT_CHOICE_SPECS
	const EVENT_SHIMMER_HZ_1
	const EVENT_SHIMMER_HZ_2
	const EVENT_SHIMMER_HZ_3
	const EVENT_SHIMMER_ITEM_1
	...
	const EVENT_SHIMMER_ITEM_2
	const EVENT_SHIMMER_ITEM_3
	const EVENT_SHIMMER_ITEM_4
	const EVENT_SHIMMER_MANKEY_2
	const EVENT_SHIMMER_MATRON_1
	const EVENT_SHIMMER_MATRON_2
	const EVENT_SHORES_ITEM_1
	const EVENT_SHORES_ITEM_2
	const EVENT_SHORES_ITEM_3
	const EVENT_KIMONO_CABIN_TM_DARK_PULSE ; NEW 
	const EVENT_KIMONO_CABIN_FAST_BALLS ; NEW 
	const EVENT_KIMONO_GAVE_VITAMINS ; new 
	const EVENT_SHORES_ITEM_4
	const EVENT_SINJOH_ITEM
	const EVENT_SINJOH_ITEM_2
	const EVENT_SINJOH_ITEM_3
	const EVENT_SLOWKING_DREAMS
	const EVENT_TAPESTRY_CELEBI
	const EVENT_TAPESTRY_SAMSARA
	const EVENT_TARN_ITEM_1
	const EVENT_TARN_ITEM_2
	const EVENT_TINDER_GARDEN_CELEBI_2
	const EVENT_TM_AVALANCHE ; move out? 
	const EVENT_TM_SWORDS_DANCE ; move out? 
	const EVENT_TM_VOLT_SWITCH ; move out? 
	const EVENT_UNION_CAVE_B2F_ABILITY
	const EVENT_WHIRL_ISLANDS_TM_REST
	const EVENT_WON_QUIZ
	const EVENT_YES_ADRINNA_BATTLE_KURT
	const EVENT_GOT_HONE_CLAWS ; 
	const EVENT_YES_ADRINNA_BATTLE_MEJIMI
	...
	const EVENT_GLACIER_B1F_ITEM_1
	const EVENT_GLACIER_B1F_ITEM_2
	const EVENT_KURTS_HOUSE_BOOK_1
	const EVENT_KURTS_HOUSE_BOOK_2
	const EVENT_KURTS_HOUSE_BOOK_3
	const EVENT_CIANWOODCAVE_REVIVE
	const EVENT_CIANWOODCITY_KURT
	const EVENT_CIANWOODCITY_EUSINE
	const EVENT_LOGGERS_ILEX_FOREST  
	const EVENT_GOT_NEST_BALLS_FROM_PROF_OAKS_AIDE ; could be moved out of visiblity 
	const EVENT_ROUTE_32_GREAT_BALL
	const EVENT_ROUTE_32_REPEL
	const EVENT_NEXUS_B1F_BOULDER_2
	const EVENT_KURTS_HOUSE_BOOK_4
	const EVENT_BEAT_AROMA_LADY_ROSA
	const EVENT_KURTS_HOUSE_BOOK_5
	const EVENT_KURTS_HOUSE_BOOK_6
	const EVENT_DESAL_1F_JASMINE
	const EVENT_DESAL_1F_CHUCK
	...
	const EVENT_GOT_TM_BULK_UP ; NEW 
	const EVENT_MURKY_SWAMP_FULL_HEAL
	const EVENT_MURKY_SWAMP_BIG_MUSHROOM
	const EVENT_GOT_TM06_TOXIC ; USED 
	const EVENT_MURKY_SWAMP_MULCH
; Johto people
	const EVENT_BRASS_TOWER_ITEM_1 ; 
	const EVENT_GAVE_MOOMOO_MILKS ; 
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_KURT
	...
	const EVENT_KURTS_HOUSE_KURT_0 ; changed
	const EVENT_PLAYERS_HOUSE_KURT_2 ; not used
	...
	const EVENT_BOULDER_IN_STADIUM_UNDERGROUND ; EVENT_BOULDER_IN_BLACKTHORN_GYM_1
...
; Kanto itemballs
	const EVENT_GOT_TM_CURSE ; NEW 
	const EVENT_GOT_LITEBLUEMAIL ; NEW 
	const EVENT_GAVE_BIG_MUSHROOM ; NEW 
	const EVENT_GOT_SHELL_BELL ; KEEP? 
	const EVENT_GOT_GOLD_LEAF ; NEW 
	const EVENT_GOT_VIOLET_POKEMON ; NEW 
	const EVENT_GOT_GIGA_DRAIN ; new 
	const EVENT_MAGNET_TUNNEL_ROTOM ; new 
	const EVENT_GOT_PUMICE_HARP ; new 
	const EVENT_MORTY_GYM ; new 
	const EVENT_BEAT_KIMONO_GIRL_IZUMI ; NEW
	const EVENT_BEAT_KIMONO_GIRL_AKARI ; NEW 
	const EVENT_PETRIE_IN_SPROUT_TOWER ; NEW 
	const EVENT_GAVE_LITEBLUEMAIL ; new 
	const EVENT_GOT_TM_AERIAL_ACE ; NEW 
	const EVENT_ROUTE_36_BRONZONG ; NEW 
	const EVENT_GOT_ZAP_CANNON ; NEW 
	const EVENT_FOUGHT_AIR_BALLOON_ROUTE_32 ; new 
	const EVENT_KIMONO_CABIN_DRATINI ; NEW 
	const EVENT_KIMONO_CABIN_SITRUS ; NEW 
	const EVENT_KIMONO_CABIN_LARVITAR ; NEW 
	const EVENT_KIMONO_CABIN_SNEASEL ; NEW 
	const EVENT_KIMONO_CABIN_LAPRAS ; NEW 
	const EVENT_KIMONO_CABIN_EEVEE ; NEW 
	const EVENT_KIMONO_CABIN_CHOICE_SCARF ; NEW 
	const EVENT_KIMONO_CABIN_POMEG_1;
	const EVENT_KIMONO_CABIN_POMEG_2;
	const EVENT_KIMONO_CABIN_POMEG_3;
	const EVENT_KIMONO_CABIN_POMEG_4;
	const EVENT_KIMONO_CABIN_POMEG_5;
	const EVENT_KIMONO_CABIN_POMEG_6;
	const EVENT_KIMONO_CABIN_POMEG_7;
	const EVENT_KIMONO_CABIN_POMEG_8;
	const EVENT_KIMONO_CABIN_POMEG_9;
	const EVENT_KIMONO_CABIN_POMEG_10;
	const EVENT_KIMONO_CABIN_POMEG_11;
	const EVENT_KIMONO_CABIN_POMEG_12;
	const EVENT_KIMONO_CABIN_POMEG_13;
	const EVENT_KIMONO_CABIN_POMEG_14;
	const EVENT_KIMONO_CABIN_POMEG_15;
	const EVENT_KIMONO_CABIN_POMEG_16;
	const EVENT_KIMONO_CABIN_REPEL ; NEW ABOVE THIS 
	const EVENT_TALKED_TO_KIMONO_2 ; NEW 
	const EVENT_VISITED_TIMELESS_TAPESTRY ; NEW 
	const EVENT_KURTS_HOUSE_NOTEBOOK ; new 
	const EVENT_LISTENED_TO_ZAP_CANNON_INTRO ; new 
	const EVENT_SOOTHE_BELL ; 
	const EVENT_BEAT_RIVAL_ROUTE_42 ; NEW 
	const EVENT_DANCE_THEATRE_OSTENE ; new 
	const EVENT_KIMONO_CABIN_5_GRANNY ; new 
	const EVENT_KIMONO_CABIN_4_GAVE_BUB_BALL ; new 
	const EVENT_KIMONO_4_LAPRAS ; new 
	const EVENT_KC4_00 ; new 
	const EVENT_GOT_EVIOLITE_FROM_DAYCARE ; NEW 
	const EVENT_EXPLAINED_SUDOKU ; new 
	const EVENT_KIMONO_CABIN_3_JEZEBALLS ; new 
	const EVENT_TALKED_TO_KIMONO_2_1 ; new 
	const EVENT_TALKED_TO_KIMONO_2_2 ;new 
	const EVENT_BEAT_KENSEY_DOCKS ; new 
	const EVENT_SOLVED_KIMONO_4_SUDOKU ; new 
	const EVENT_BEAT_REI ; new 
	const EVENT_EMPERORS_GARDEN_MEJIMI ; 
	const EVENT_EMPERORS_GARDEN_BOBESH  ;
	const EVENT_EMPERORS_GARDEN_KENSEY ; 
	const EVENT_EMPERORS_GARDEN_ADRINNA ; 
	const EVENT_EMPERORS_GARDEN_PROTEIN ; 
	const EVENT_EMPERORS_GARDEN_CALCIUM  ;
	const EVENT_EMPERORS_GARDEN_CARBOS ; 
	const EVENT_EMPERORS_GARDEN_SEED_BOMB ; 
	const EVENT_LISTENED_TO_SEED_BOMB_INTRO ; NEW 
	const EVENT_WESTERN_CAPITAL_CIVILIAN ; NEW 
	const EVENT_ECRUTEAK_BOULDER_1 ; 
	const EVENT_ECRUTEAK_BOULDER_2 ; 
	const EVENT_BRASS_TOWER_LEFT_GUARD ; 
	const EVENT_BRASS_TOWER_RIGHT_GUARD ; 
	const EVENT_BRASS_TOWER_13F_UNOWN ; new 
	const EVENT_KIMONO_CABIN_2_REPEL_CHECK ; new 
	const EVENT_BRASS_TOWER_JOLTEON ; 
	const EVENT_BRASS_TOWER_VAPOREON ; 
	const EVENT_BRASS_TOWER_FLAREON ; 
	const EVENT_TIN_TOWER_OLD_HAUNTER_1 ; 
	const EVENT_TIN_TOWER_OLD_HAUNTER_2 ;  
	const EVENT_TIN_TOWER_OLD_HAUNTER_3 ; 
	const EVENT_TIN_TOWER_OLD_HAUNTER_4 ; 
	const EVENT_TALKED_TO_BARBEAU ; 
	const EVENT_MISTY_BASIN_FRESH_WATER ; 
	const EVENT_HAMLET_IRON ;
	const EVENT_HAMLET_ENERGYPOWDER ; 
	const EVENT_GAVE_MASTER_BALL ;  
	const EVENT_LANDING_KURT_2 ; 
	const EVENT_CALM_COAST_HIDDEN_1
	const EVENT_CALM_COAST_HIDDEN_2
	const EVENT_GAULDENROD_HIDDEN_1
	const EVENT_GAULDENROD_HIDDEN_2
	const EVENT_SPRINGS_HIDDEN_1
	const EVENT_STADIUM_HIDDEN_1
	const EVENT_STADIUM_HIDDEN_2
	const EVENT_STADIUM_HIDDEN_3
	const EVENT_WC_HIDDEN_1
	const EVENT_WC_HIDDEN_2
	const EVENT_CC38_HIDDEN_1
	const EVENT_CC38_HIDDEN_2
	const EVENT_CC39_HIDDEN_1
	const EVENT_CC39_HIDDEN_2
	const EVENT_LANDING_HIDDEN_1
	const EVENT_FJORD_HIDDEN_1
...
; Kanto people
	const EVENT_BEAT_KIMONO_GIRL_EMI ; NEW 
	const EVENT_CATACOMBS_BOULDER_1
	const EVENT_CATACOMBS_BOULDER_2
	const EVENT_SOLVED_CATACOMBS_PUZZLE
	const EVENT_SET_DVS_1 ; new 
	const EVENT_BEAT_KROMA ; new 
...
; Orange itemball
	const EVENT_SHIMMER_SADDLE_BOULDER
	const EVENT_KILN_BOSS
	const EVENT_ANCHORAGE_HIDDEN_1
	const EVENT_ANCHORAGE_HIDDEN_2
	const EVENT_WESTERN_GLACIER_HIDDEN_1
	const EVENT_WESTERN_GLACIER_HIDDEN_2
	const EVENT_GOT_TM_DRAIN_PUNCH ; new
	const EVENT_WESTERN_GLACIER_HIDDEN_3
	const EVENT_WESTERN_GLACIER_HIDDEN_4
	const EVENT_WESTERN_GLACIER_HIDDEN_5
	const EVENT_HIDDEN_STY_1
	const EVENT_HIDDEN_STY_2
	const EVENT_HIDDEN_STY_3
	const EVENT_HIDDEN_STY_4
; Orange people
	const EVENT_HIDDEN_TAPESTRY_1
	const EVENT_HIDDEN_TAPESTRY_2
	const EVENT_HIDDEN_CRADLE_1
	const EVENT_HIDDEN_CRADLE_2
	const EVENT_HIDDEN_CRADLE_3
	const EVENT_GLACIER_LUCARIO
	const EVENT_CATACOMBS_NOCTOWL
; New to Crystal
	...
	const EVENT_PICKED_UP_SOOTHE_BELL_FROM_AERODACTYL_ITEM_ROOM ; new 
...
; Cut trees
	const EVENT_HOLLYS_HOLT_CUT_TREE
