...
; Johto story events
	...
	const EVENT_CHARCOAL_TALKED ;FROM MYSTERY EGG EVENT
	const EVENT_GOT_POKEDEX_FROM_OAK
	const EVENT_KURT_HEARS_LOGGERS
	const EVENT_LOGGERS_ILEX_FOREST ;EVENT_INTRODUCED_TEALA
	...
	const EVENT_GOT_TINYMUSHROOM ; NEW 
	const EVENT_GAVE_MINT_LEAF ; NEW
	const SUMMONED_CELEBI_IN_ILEX ;ss ticket
	...
	const EVENT_GOT_BRICK_PIECE_FROM_CAMPER ; new 
	...
	const EVENT_GAULDENROD_OCTILLERY ; NEW 
	...
	const EVENT_LISTENED_TO_SEED_BOMB_INTRO_OLD
...
; Johto hidden items
	...
	const EVENT_GOT_GYRO_BALL ; USED 
