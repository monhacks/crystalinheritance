WesternCapitalStockroom_MapScriptHeader: ;	def_scene_scripts
	...
	object_event  9,  1, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_COMMAND, pokemart, MARTTYPE_TM,  MART_WESTERN_CAPITAL_2, -1 ; POKEBALLS 
