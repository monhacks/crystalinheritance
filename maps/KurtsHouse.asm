...
.AskApricorn:
	...
	ifequal PNK_APRICORN, .Blu
	ifequal PNK_APRICORN, .Ylw
	ifequal PNK_APRICORN, .Grn
	ifequal WHT_APRICORN, .Wht
	ifequal PNK_APRICORN, .Blk ; hlw rok
...
.GiveLevelBall:
	...
	promptbutton
	verbosegiveitemvar POKE_BALL, VAR_KURT_APRICORNS
	iffalse_endtext
