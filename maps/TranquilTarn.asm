...
; trainers are excited about the dragons, need to finish 
	...
	object_event  22,  10, SPRITE_RUIN_MANIAC, 	SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_GENERICTRAINER, 1, GenericTrainerRuinManiacJones, EVENT_BEAT_KANNA
	...
	tmhmball_event 31, 29, TM_AVALANCE, EVENT_TM_AVALANCHE
