...
RoyalBlessingIcon::   INCBIN "gfx/items/royal_blessing.2bpp.lz"
...
LaggingTailIcon::  INCBIN "gfx/items/lagging_tail.2bpp.lz"
...
UnownReportIcon::  INCBIN "gfx/items/unownreport.2bpp.lz"
