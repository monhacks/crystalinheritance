	...
	tilecoll WARP_CARPET_UP, WARP_CARPET_UP, FLOOR, FLOOR ; 65
	tilecoll FLOOR, FLOOR, FLOOR, HOLE ; 66
	...
	tilecoll HOLE, HOLE, HOLE, FLOOR ; 7b
	...
	tilecoll FLOOR, WARP_CARPET_RIGHT, FLOOR, WARP_CARPET_RIGHT ; 94
