...
; ================
	...
	db 40, VENOMOTH, SILVERPOWDER,  DVS_HP_GHOST,"BeetleJuce@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 42, PRIMEAPE, LIFE_ORB,  DVS_HP_ROCK,"Pepped@"
	...
	db 43, POLIWRATH, MYSTIC_WATER,  DVS_HP_FIGHTING,"TadSwole@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 40, MAGNEZONE, MAGNET, DVS_HP_ELECTRIC, "Polaris@"
	...
	db 44, SKARMORY, LEFTOVERS,  DVS_HP_BUG,"Vultron@"
		db TOXIC, ROOST, STEEL_WING, DRILL_PECK
	db 43, RHYPERIOR, CHOICE_SCARF, DVS_HP_STEEL, "Wrecker@"
...
; ================
	...
	db 43, SNEASEL, NEVERMELTICE,  DVS_HP_POISON,"SneaSalt@"
...
; ================
	...
	db 48, GYARADOS, CHOICE_BAND, DVS_HP_GROUND, "DoAGyros@"
	...
	db 46, KANGASKHAN, CHOICE_SCARF, DVS_HP_DRAGON, "ShankKanga@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 57, HERACROSS, SCOPE_LENS, DVS_HP_BUG, "Ohmu@" ; nausicaa  ; hp bug 
	...
	db 57, URSALUNA, FLAME_ORB, DVS_HP_FIRE, "Okkoto@" ; mononoke  ; hp fire 
		db EARTHQUAKE, FACADE, REST, SLEEP_TALK
	db 58, WYRDEER, WIDE_LENS, DVS_HP_PSYCHIC, "Yubaba@" ; spirited away  ; hp psychic? 
...
; ================
	...
	db 55, NIDOKING, POISON_BARB, DVS_HP_DRAGON, "Seigidoku@"
		db SLUDGE_BOMB, EARTHQUAKE, POISON_JAB, THUNDER		
	db 55, H__GOODRA, CHESTO_BERRY, FAKE_PERFECT_DVS, "Youkiri@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 48, WIGGLYTUFF, NO_ITEM, FAKE_PERFECT_DVS, "Crescendo@"
		db COUNTER, BLIZZARD, FIRE_BLAST, HYPER_VOICE
	db 49, TOGEKISS, NO_ITEM,FAKE_PERFECT_DVS,  "Clutch@"
	...
	db 50, CLEFABLE, NO_ITEM,FAKE_PERFECT_DVS,  "Supernova@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 31, STANTLER, ZOOM_LENS,DVS_HP_GHOST, "Pallbearer@"
		db HI_JUMP_KICK, HYPNOSIS, STOMP, U_TURN
	db 28, GENGAR, LUM_BERRY, DVS_HP_DARK,"Te No Me@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 45, BRONZONG, NO_ITEM, FAKE_PERFECT_DVS, "Overtone@"
	...
	db 49, H__TYPHLOSION, NO_ITEM,FAKE_PERFECT_DVS,  "Golaris@"
		db SHADOW_BALL, FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH
	db 49, H__DECIDUEYE, NO_ITEM,FAKE_PERFECT_DVS,  "Brawnshuf@"
		db AURA_SPHERE, ENERGY_BALL, AIR_SLASH, CLOSE_COMBAT
	db 49, H__SAMUROTT, NO_ITEM, FAKE_PERFECT_DVS, "Mabbulwark@"
...
; ================
	...
	db 55, SUNFLORA, SITRUS_BERRY, FAKE_PERFECT_DVS, "Helia@"
	...
	db 55, FLAREON, LEFTOVERS, FAKE_PERFECT_DVS, "Kotei@"
...
; ================
	...
	db 27, ELECTABUZZ, NO_ITEM,  FAKE_PERFECT_DVS, "Vajrand@" ; thunderbolt, rand 
		db THUNDERBOLT, KARATE_CHOP, NO_MOVE, NO_MOVE
	db 33, JOLTEON, NO_ITEM,  DVS_HP_DRAGON, "Indrage@" ; indra plus rage 
		db SPARK, DOUBLE_KICK, THUNDER_WAVE, HIDDEN_POWER
	db -1 ; end
	...
	db 52, JOLTEON, NO_ITEM, DVS_HP_DRAGON, "Indrage@"
	...
	db 57, JOLTEON, SITRUS_BERRY, DVS_HP_DRAGON, "Indrage@"
...
; ================
	...
	db 35, SHUCKLE, CHESTO_BERRY, DVS_HP_GHOST, "Rumbler@"
		db REST, DEFENSE_CURL, ROLLOUT, WRAP		
	db 35, CORSOLA, NO_ITEM, DVS_HP_BUG, "Cnidaran@"
	...
	db 40, LANTURN, CHESTO_BERRY, DVS_HP_WATER, "Unfathom@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 49, AMPHAROS, NO_ITEM,  FAKE_PERFECT_DVS, "Neonovis@"
	...
	db 48, STARMIE, NO_ITEM, FAKE_PERFECT_DVS,  "HangTen@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 44, ABOMASNOW, CHOICE_SCARF, FAKE_PERFECT_DVS, "Sarakka@" ; CONTROL WEATHER
		db BLIZZARD, PETAL_DANCE, EARTHQUAKE, NO_MOVE
	db 46, SNEASLER, RAZOR_CLAW,  FAKE_PERFECT_DVS, "Lieabolmai@"  ; hunter 
		db POISON_JAB, NIGHT_SLASH, SLASH, QUICK_ATTACK
	db 42, H__AVALUGG, FOCUS_SASH,FAKE_PERFECT_DVS, "Sieidi@";mountain home 
		db ROCK_SLIDE, EARTHQUAKE, AVALANCHE, MIRROR_COAT
	db 44, H__BRAVIARY, NO_ITEM,DVS_HP_PSYCHIC,  "Bieggolmai@" ; wind spirit
		db AIR_SLASH, PSYCHIC_M, ROOST, NIGHT_SHADE
	db 48, FROSLASS, SPELL_TAG,DVS_HP_GHOST,  "JahbmeAkka@" ; dead
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 53, FERALIGATR, EXPERT_BELT,FAKE_PERFECT_DVS,  "Trapjaw@"
	...
	db 55, H__SLIGGOO, LEFTOVERS, FAKE_PERFECT_DVS, "AcidTide@"
