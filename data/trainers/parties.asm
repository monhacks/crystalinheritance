...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 40, POLIWRATH, NO_ITEM, "NAME@"
		db SURF, HYPNOSIS, DYNAMICPUNCH, BODY_SLAM
	db 45, PRIMEAPE, NO_ITEM, "NAME@"
		db DYNAMICPUNCH, ROCK_SLIDE, SCREECH, NO_MOVE
	db 43, GALLADE, NO_ITEM, "NAME@"
		db ZEN_HEADBUTT, KARATE_CHOP, BULK_UP, NO_MOVE
	db 44, TOXICROAK, NO_ITEM, "NAME@"
		db SUCKER_PUNCH, SWORDS_DANCE, POISON_JAB, KARATE_CHOP
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 40, MAGNEZONE, NO_ITEM, "NAME@"
		db RAIN_DANCE, THUNDER, THUNDERBOLT, FLASH_CANNON
	db 45, STEELIX, CHOICE_BAND, "NAME@"
		db STONE_EDGE, EARTHQUAKE, IRON_TAIL, NO_MOVE
	db 44, SKARMORY, NO_ITEM, "NAME@"
		db TOXIC, ROOST, STEEL_WING, DRILL_PECK
	db 43, RHYPERIOR, NO_ITEM, "NAME@"
		db ROCK_SLIDE, EARTHQUAKE, BODY_SLAM, CURSE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 45, CLOYSTER, FOCUS_BAND, "NAME@"
		db SPIKES, EXPLOSION, HAIL, NO_MOVE
	db 46, LAPRAS, NO_ITEM, "NAME@"
		db PERISH_SONG, THUNDER_WAVE, THUNDERBOLT, ICE_BEAM
	db 45, MAMOSWINE, NO_ITEM, "NAME@"
		db ICE_SHARD, EARTHQUAKE, STOMP, ROAR
	db 48, JYNX, NO_ITEM, "NAME@"
		db PSYCHIC_M, ICE_BEAM, METRONOME, NO_MOVE
	db 45, GLACEON, LEFTOVERS, "NAME@"
		db BLIZZARD, SHADOW_BALL, PROTECT, MUD_SLAP
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 48, GYARADOS, CHOICE_BAND, "NAME@"
		db EARTHQUAKE, STRENGTH, WATERFALL, FLY
	db 50, KINGDRA, CHESTO_BERRY, "NAME@"
		db DRAGON_DANCE, OUTRAGE, WATERFALL, REST
	db 47, DRAGONAIR, EVIOLITE, "NAME@"
		db DRAGON_DANCE, OUTRAGE, AQUA_JET, REST
	db 46, KANGASKHAN, CHOICE_SCARF, "NAME@"
		db DOUBLE_EDGE, SHADOW_CLAW, NO_MOVE, NO_MOVE
	db 50, H__GOODRA, NO_ITEM, "NAME@"
		db IRON_HEAD, OUTRAGE, TOXIC, PROTECT
	db -1 ; end
...
; ================
	...
	db 57, JOLTEON, NO_ITEM, DVS_HP_ICE, "Indrage@"
