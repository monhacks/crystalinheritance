...
; ================================
	...
	; party
	db 24, WIGGLYTUFF, SITRUS_BERRY, "Resonator@"
		db ATTRACT, HYPER_VOICE, METRONOME, SING
	db 24, NIDOQUEEN, CHESTO_BERRY, "BriarRose@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 40, MAGNEZONE, MAGNET, "Polaris@"
		db RAIN_DANCE, THUNDER, VOLT_SWITCH, FLASH_CANNON
	db 45, STEELIX, CHOICE_BAND, "ShinyHulud@"
		db STONE_EDGE, EARTHQUAKE, IRON_TAIL, NO_MOVE
	db 44, SKARMORY, LEFTOVERS, "Vultron@"
		db TOXIC, ROOST, STEEL_WING, DRILL_PECK
	db 43, RHYPERIOR, CHOICE_SCARF, "Wrecker@"
...
; ================
	...
	db 42, LAPRAS, NO_ITEM, "dOeuvRas@"
		db PERISH_SONG, THUNDER_WAVE, THUNDERBOLT, ICE_BEAM
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 47, DRAGONAIR, EVIOLITE, "GordianRa@"
		db WRAP, FIRE_BLAST, REST, THUNDER_WAVE
	db 48, GYARADOS, CHOICE_BAND, "DoAGyros@"
		db EARTHQUAKE, STRENGTH, WATERFALL, FLY
	db 50, KINGDRA, CHESTO_BERRY, "DarkGin@"
		db DRAGON_DANCE, OUTRAGE, WATERFALL, REST
	db 46, KANGASKHAN, CHOICE_SCARF, "ShankKanga@"
		db SLASH, NO_MOVE, NO_MOVE, NO_MOVE
	db 50, H__GOODRA, LEFTOVERS, "GoHoard@"
		db IRON_HEAD, DRAGON_CLAW, TOXIC, PROTECT
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 50, HERACROSS, SCOPE_LENS, "Ohmu@" ; nausicaa 
		db MEGAHORN, SWORDS_DANCE, CLOSE_COMBAT, EARTHQUAKE
	db 51, UMBREON, LEFTOVERS, "Howl@" ; moving castle 
		db RECOVER, CURSE, SUCKER_PUNCH, TOXIC
	db 52, URSALUNA, FLAME_ORB, "Okkoto@" ; mononoke  
		db EARTHQUAKE, FACADE, REST, SLEEP_TALK
	db 53, WYRDEER, WIDE_LENS, "Yubaba@" ; spirited away 
		db HYPNOSIS, ZEN_HEADBUTT, HI_JUMP_KICK, BODY_SLAM
	db 54, KLEAVOR, HARD_STONE, "Piccolo@" ; porco rosso 
		db ROCK_SLIDE, X_SCISSOR, QUICK_ATTACK, SWORDS_DANCE
	db 55, CELEBI, LEFTOVERS, "@" ; no nickname?
...
; ================
	...
	db 55, NIDOKING, POISON_BARB, "Seigidoku@"
		db SLUDGE_BOMB, EARTHQUAKE, POISON_JAB, THUNDER		
	db 55, H__GOODRA, CHESTO_BERRY, "Youkiri@"
		db FLASH_CANNON, SLUDGE_BOMB, DRAGON_PULSE, HYDRO_PUMP
	db 56, DRAGONITE, LIFE_ORB, "Mahoryu@"
		db OUTRAGE, WATERFALL, FLY, ROOST
	db 57, SCIZOR, METAL_COAT, "Tetsukai@"
		db BULLET_PUNCH, SWORDS_DANCE, X_SCISSOR, IRON_HEAD
	db 60, HO_OH, SITRUS_BERRY, "Akatori@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 48, WIGGLYTUFF, NO_ITEM, "Crescendo@"
		db COUNTER, BLIZZARD, FIRE_BLAST, HYPER_VOICE
	db 49, TOGEKISS, NO_ITEM, "Clutch@"
		db ROOST, AIR_SLASH, EXTRASENSORY, METRONOME
	db 50, GRANBULL, NO_ITEM, "Winston@"
		db PLAY_ROUGH, CRUNCH, BODY_SLAM, SCREECH
	db 50, CLEFABLE, NO_ITEM, "Supernova@"
...
; ================
	...
	db 48, KLEAVOR, METAL_COAT, 20
		db ROCK_SLIDE, WING_ATTACK, X_SCISSOR, SWORDS_DANCE
	db -1 ; end
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 30, QUILAVA, CHARCOAL, "Golaris@"
		db FLAME_CHARGE, DEFENSE_CURL, DIG, ROLLOUT
	db 30, DARTRIX, MIRACLE_SEED, "Brawnshuf@"
		db ROOST, ENERGY_BALL, WING_ATTACK, RAZOR_LEAF
	db 30, DEWOTT, MYSTIC_WATER, "Mabbulwark@"
		db AQUA_TAIL, SLASH, HEADBUTT, WATER_PULSE
	db 32, GALLADE, NO_ITEM, "Oatharav@"
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 48, H__ELECTRODE, LEFTOVERS, "Casabaraq@"
		db LEECH_SEED, THUNDER_WAVE, GIGA_DRAIN, VOLT_SWITCH
	db 49, H__TYPHLOSION, NO_ITEM, "Golaris@"
		db SHADOW_BALL, FIRE_BLAST, WILL_O_WISP, THUNDERPUNCH
	db 49, H__DECIDUEYE, NO_ITEM, "Brawnshuf@"
		db AURA_SPHERE, ENERGY_BALL, AIR_SLASH, CLOSE_COMBAT
	db 49, H__SAMUROTT, NO_ITEM, "Mabbulwark@"
		db SWORDS_DANCE, CRUNCH, WATERFALL, SLASH
	db 51, GALLADE, NO_ITEM, "Oatharav@"
...
; ================
	...
	db 27, LUXIO, FOCUS_SASH, "Kalamp@" ; darkness, amp 
		db ROAR, BITE, SPARK, NO_MOVE
	db 27, ELECTABUZZ, NO_ITEM, "Vajrand@" ; thunderbolt, rand 
		db THUNDERBOLT, KARATE_CHOP, NO_MOVE, NO_MOVE
	db 33, JOLTEON, NO_ITEM, "Indrage@" ; indra plus rage 
	...
	; party
	db 46, FORRETRESS, FOCUS_SASH, FAKE_PERFECT_DVS, "KiloJaal@"
		db SPIKES, EXPLOSION, U_TURN, NO_MOVE		
	db 46, WEAVILE, NO_ITEM, FAKE_PERFECT_DVS, "Chayarctic@" ; shadow arctic 
		db ICE_PUNCH, NIGHT_SLASH, FEINT_ATTACK, ICE_SHARD
	db 48, HONCHKROW, NO_ITEM, FAKE_PERFECT_DVS, "Kalraja@" ; dark king 
		db DRILL_PECK, DARK_PULSE, NIGHT_SHADE, NO_MOVE
	db 50, LUXRAY, NO_ITEM, FAKE_PERFECT_DVS, "Kalamp@"
		db CRUNCH, SPARK, DOUBLE_EDGE, NO_MOVE
	db 50, JOLTEON, NO_ITEM, DVS_HP_ICE, "Indrage@"
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_DVS | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 57, MAGNEZONE, NO_ITEM, FAKE_PERFECT_DVS, "Yogauss@" ; union , gauss 
	...
	db 55, WEAVILE, NO_ITEM, FAKE_PERFECT_DVS, "Chayarctic@"
	...
	db 57, JOLTEON, SITRUS_BERRY, DVS_HP_ICE, "Indrage@"
...
; ================
	...
	db TRAINERTYPE_ITEM | TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES
	; party
	db 49, AMPHAROS, NO_ITEM, "Neonovis@"
		db FLASH, THUNDERBOLT, POWER_GEM, THUNDER_WAVE
	db 45, LANTURN, CHESTO_BERRY, "Unfathom@"
		db SURF, THUNDERBOLT, REST, SLEEP_TALK
	db 45, CORSOLA, LEFTOVERS, "Cnidaran@"
		db MIRROR_COAT, SURF, TOXIC, RECOVER
	db 48, STARMIE, NO_ITEM, "HangTen@"
		db WHIRLPOOL, SURF, ICE_BEAM, RECOVER
	db 50, SHUCKLE, CHESTO_BERRY, "Rumbler@"
		db REST, DEFENSE_CURL, ROLLOUT, WRAP
	db -1 ; end
...
; ================
	...
	db 46, H__SNEASLER, RAZOR_CLAW,  "Lieabolmai@"  hunt
		db POISON_JAB, NIGHT_SLASH, SLASH, QUICK_ATTACK
	db 42, H__AVALUGG, FOCUS_BAND, "Sieidi@";mountain home 
		db ROCK_SLIDE, EARTHQUAKE, AVALANCHE, MIRROR_COAT
	db 44, H__BRAVIARY, NO_ITEM, "Bieggolmai@" ; wind spirit
		db AIR_SLASH, PSYCHIC_M, ROOST, NIGHT_SHADE
	db 48, FROSLASS, SPELL_TAG, "JahbmeAkka@" ; dead
