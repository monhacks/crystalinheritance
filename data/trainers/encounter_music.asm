...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	db MUSIC_OFFICER_ENCOUNTER ; HOLLIS
	...
	db MUSIC_OFFICER_ENCOUNTER ; ninja
	...
	db MUSIC_OFFICER_ENCOUNTER ; BRIGADER
...
;	assert_table_length ARIANA + 1, used to have all of these below commented out. 
